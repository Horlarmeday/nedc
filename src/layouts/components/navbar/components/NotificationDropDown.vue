<template>
  ...
  <vs-dropdown vs-custom-content vs-trigger-click class="cursor-pointer">
    <feather-icon icon="ActivityIcon" class="cursor-pointer mt-1 sm:mr-6 mr-2" :badge="unreadNotifications.length" />
      ...
      unreadNotifications: [
          {
            index    : 0,
            title    : 'New Activity',
            msg      : 'ABD Contractors Ltd just uploaded some project photos',
          ...
          { index    : 1,
            title    : 'New Progress',
            msg      : 'LM. Plc just moved MAIADUA WATER PROJECT to Done.',
            icon     : 'PackageIcon',
          ...
          { index    : 2,
            ...
            msg      : 'BORNO HOUSE RENOVATION project timeline is overdue',
